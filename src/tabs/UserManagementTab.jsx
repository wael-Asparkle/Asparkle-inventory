...
const ROLE_ACCESS_SUMMARY = {
  [ROLES.ADMIN]: {
    title: 'يرى كل النظام',
    items: ['لوحة التحكم', 'الرئيس التنفيذي', 'إدخالات الأقسام', 'المخزون', 'الحركات', 'الطلبات', 'العملاء', 'استيراد', 'Between', 'CS مرتجعات', 'إدارة البيانات', 'المستخدمون والصلاحيات'],
  ...
  [ROLES.OPERATIONS]: {
    ...
    items: ['إدخالات قسم العمليات', 'المخزون', 'الحركات', 'الطلبات', 'Between', 'CS مرتجعات'],
    note: 'يرى ويدخل بيانات قسم العمليات فقط داخل إدخالات الأقسام.',
  },
  [ROLES.MARKETING]: {
    title: 'صلاحيات التسويق والعملاء',
    items: ['إدخالات قسم التسويق', 'لوحة التحكم', 'العملاء'],
    note: 'يرى ويدخل بيانات قسم التسويق فقط داخل إدخالات الأقسام.',
  },
  [ROLES.FINANCE]: {
    title: 'صلاحيات المالية',
    items: ['إدخالات قسم المالية'],
    note: 'يرى ويدخل بيانات قسم المالية فقط، ولا يرى إدخالات الأقسام الأخرى.',
  },
  [ROLES.CUSTOMER_SERVICE]: {
    title: 'صلاحيات خدمة العملاء',
    items: ['إدخالات قسم خدمة العملاء'],
    note: 'يرى ويدخل بيانات خدمة العملاء فقط، ولا يرى إدخالات الأقسام الأخرى.',
  },
  [ROLES.VIEWER]: {
    title: 'مشاهدة محدودة',
    items: ['لوحة التحكم', 'المخزون', 'الحركات', 'الطلبات', 'العملاء'],
    note: 'مشاهدة فقط، بدون صفحات الإدارة أو الاستيراد أو إدخالات الأقسام أو المستخدمين.',
  },
};
